...
class Car(Vehicle):
    ...
    def scenario_obj(self):
        ...
        if self.ego:
            ...
            vehicle["Axles"]["RearAxle"].update({"wheelDiameter": 0.5236, "trackWidth": 0.78, "positionZ": 0.39})
            ...
            vehicle["Axles"]["RearAxle"].update({"wheelDiameter": 0.5236, "trackWidth": 1.8, "positionZ": 0.3})
...
class OpenScenario:
    ...
    def get_scenario_profile(self) -> Dict[str, Any]:
        ...
        entities.extend([self.get_corresponding_entity(x) for x in self.obstacles])
