...
from config import BACKUP_CONFIG_SAVE_DIR, ADS_RECORDS_DIR, BACKUP_RECORD_SAVE_DIR, ADS_ROOT, EXP_BASE_DIR, \
    ADS_TEMP_SCENARIO_DIR
from tools.file_handling import move_dir
...
class FileOutputManager:
    ...
    #     shutil.copy(AUTOWARE_CURRENT_CONFIG_DIR_PATH, f"{self.config_file_save_path}/{ind_id}/{MODULE_NAME}_config.pb.txt")
    ...
    # def save_record(self, scenario):
    #     self.delete_dir(f"{self.backup_record_file_save_path}/{scenario.record_dir}", mk_dir=False)
    #     move_dir(scenario.record_dir, f"{self.backup_record_file_save_path}/{scenario.record_dir}")
    #     # shutil.copy(scenario.record_dir,
    #     #             f"{self.backup_record_file_save_path}/{scenario.record_name}_0.db3")
