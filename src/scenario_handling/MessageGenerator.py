...
from config import AV_TESTING_APPROACH, MAX_INITIAL_SCENARIOS, ADS_SCENARIO_DIR, PROJECT_ROOT, MAP_NAME
...
class MessageGenerator:
    ...
    def get_record_path_list(self):
        ...
        # scenario_recordname_list = listdir(self.scenario_dir_path)
        ...
        # self.scenario_recordname_list = [recordname.split(".")[0] for recordname in listdir(self.scenario_dir_path)]
        self.scenario_recordname_list = scenario_recordname_list
